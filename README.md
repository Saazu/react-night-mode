This is a simple react app that shows a simple to-do list interface(see screenshots folder). Night mode is  implemented usinf React Context API (Provider Pattern).
